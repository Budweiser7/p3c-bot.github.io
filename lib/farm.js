...
function getMyCrop(onboard) {
    farmContract.myCrop.call(function (err, result) {
        ...
        if (err || (result == '0x0000000000000000000000000000000000000000')) {
            alertify.prompt("Welcome to P3C", "To join, you need a little crop. Send a little ETC along with it to get started!", ".001",
                function (evt, value) {
                    deployCrop(amount, '0x0000000000000000000000000000000000000000')
                    alertify.success('Ok: ' + amount);
