    ...
    farmContract.myCrop.call(function (err, result) {
        ...
        if (err || (result == '0x0000000000000000000000000000000000000000')) {
            alertify.confirm('Welcome to P3C',
                `
                <p>
                !!!3C is an autonomous smart contract. You can read it here. By clicking OK, you acknowledge that the contract will be run exactly as written and that code is law.
                </p>
