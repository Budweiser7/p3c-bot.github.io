    ...
    farmContract.myCrop.call(function (err, result) {
        ...
        if (err || (result == '0x0000000000000000000000000000000000000000')) {
            alertify.confirm('Welcome to P3C',
                `
                <p>
                P3C is an autonomous smart contract. You can read it here. By clicking OK, you acknowledge that the contract will be run exactly as written and that code is law.
                </p>
                ...
                <div class="ui input onboard">
                    <input type="text" placeholder="Custom ETC Amount">
                </div>
                <img src="img/etc-logo.png" class="ui image etc-logo" />
                `,
                function () {
                    alertify.success($('#1etc').val())
                    getNewCropValue()
                },
                function () {
            ...
            //     deployCrop(value, '0x0000000000000000000000000000000000000000')
...
function getNewCropValue() {
    var etcToBuy = 0;
    if ($('#1etc').val() == "1") etcToBuy = 1
    if ($('#5etc').val() == "5") etcToBuy = 5
    if ($('#10etc').val() == "10") etcToBuy = 10
    if ($('#50etc').val() == "50") etcToBuy = 50
    alert(etcToBuy)
